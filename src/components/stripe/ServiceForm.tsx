              ...
              <div className="grid grid-cols-2 gap-3">
                <label className="relative">
                  ...
                  <div className={`p-4 border rounded-lg cursor-pointer transition-colors ${
                    ...
                    <div className="font-medium text-white">One-time Session</div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full rounded-md border border-gray-600 bg-gray-800 text-white px-3 py-2 focus:outline-none focus:ring-1 focus:ring-blue-500"
                    >
