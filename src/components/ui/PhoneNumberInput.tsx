      ...
      <div className="relative">
        <div className={`flex rounded-md border ${
          displayError 
            ...
            : 'border-gray-600 focus-within:border-blue-500 focus-within:ring-blue-500'
        } bg-gray-800 focus-within:ring-1`}>
          
          {/* Country Code Dropdown */}
          <div className="relative">
            <button
              type="button"
              className="flex items-center px-3 py-2 border-r border-gray-600 bg-gray-700 hover:bg-gray-600 rounded-l-md transition-colors"
              onClick={() => setIsDropdownOpen(!isDropdownOpen)}
              disabled={disabled}
            >
              <span className="mr-2">{selectedCountry.flag}</span>
              <span className="text-gray-300 text-sm">{selectedCountry.dialCode}</span>
            ...
            {/* Dropdown Menu */}
            {isDropdownOpen && (
              <div className="absolute top-full left-0 z-50 w-80 mt-1 bg-gray-800 border border-gray-600 rounded-md shadow-lg max-h-60 overflow-y-auto">
                {COUNTRIES.map((country) => (
                  <button
                    key={country.code}
                    type="button"
                    className="w-full px-3 py-2 text-left hover:bg-gray-700 flex items-center text-gray-300 text-sm"
          ...
          <div className="flex-1 relative">
            <input
              ...
              disabled={disabled}
              className="w-full px-3 py-2 bg-transparent text-white placeholder-gray-400 focus:outline-none rounded-r-md"
            />
