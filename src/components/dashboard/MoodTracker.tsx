...
export const MoodTracker: React.FC = () => {
  ...
  return (
    <div className="bg-gray-800 rounded-2xl border border-gray-700 p-8 shadow-lg">
      <div className="mb-8">
        <div className="mb-8">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
            <div>
              <h3 className="text-white text-2xl font-bold mb-4">Mood Trend</h3>
              ...
              <div className="flex items-center space-x-3">
                <span className="text-gray-400 text-sm">{getCurrentRangeDescription()}</span>
        ...
        <div className="h-64 mb-6">
          {data.some(d => d > 0) ? (
            ...
            <div className="h-full flex items-center justify-center bg-gray-700/30 rounded-xl border-2 border-dashed border-gray-600">
              <div className="text-center">
                <div className="text-gray-400 text-2xl mb-3">📊</div>
                <p className="text-gray-400 text-base font-medium">No mood data for {getCurrentRangeDescription().toLowerCase()}</p>
      ...
      <div className="border-t border-gray-700 pt-8">
        <h3 className="text-xl font-bold text-white mb-6">Log Your Mood Right Now</h3>
