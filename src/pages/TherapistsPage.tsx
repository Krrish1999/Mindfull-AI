...
export const TherapistsPage: React.FC = () => {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-100">Find a Therapist</h1>
        <p className="text-gray-100">Connect with licensed professionals who can help with your mental health journey</p>
      </div>
      ...
      {isLoading ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {Array(6).fill(0).map((_, index) => (
            <div key={index} className="animate-pulse bg-white rounded-lg shadow-sm h-80">
              <div className="h-1/3 bg-gray-200 rounded-t-lg"></div>
              <div className="p-6">
