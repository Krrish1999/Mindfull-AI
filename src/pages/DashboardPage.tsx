  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      <div className="text-center mb-8">
        <h1 className="text-white text-3xl font-bold tracking-tight mb-3">Your Mood Summary</h1>
        <p className="text-gray-400 text-base max-w-2xl mx-auto">Here's a snapshot of your recent emotional trends and insights.</p>
      </div>
      ...
      <div className="mt-12">
        <div className="mb-6">
          <h2 className="text-white text-2xl font-bold tracking-tight mb-4">Recently Viewed Resources</h2>
        </div>
          ...
          {resourcesLoading ? (
            ...
            featuredResources.slice(0, 3).map(resource => (
              <div key={resource.id} className="group cursor-pointer">
                <div
                  className="w-full bg-center bg-no-repeat aspect-video bg-cover rounded-xl transition-transform group-hover:scale-105"
                  style={{
                ...
                ></div>
                <div className="mt-4">
                  <h3 className="text-white text-lg font-semibold leading-snug mb-2 group-hover:text-blue-400 transition-colors">
                    {resource.title}
                  </h3>
